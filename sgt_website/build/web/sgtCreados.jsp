...
<html>
     <head>
        ...
        <script>
           ...
           function ejecutaCodigo(nombre){
               document.f_forma.action = "Controller?event=DETALLE_CREADOS";
	...
	barra = util.mostrarBarra(rol);
            ...
            String tabla = pendiente.verRequerimientosCreadosUsuarioLog(ficha, planta);
        ...
        <div id="UsuarioSesion">
            ...
            <label id="tituloPendiente" style="margin-left: 1%;">Requerimientos creados</label>
