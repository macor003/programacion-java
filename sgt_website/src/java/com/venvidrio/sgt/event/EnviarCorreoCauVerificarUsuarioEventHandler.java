 ...
 * @author Ortegam
 */
public class EnviarCorreoCauVerificarUsuarioEventHandler extends EventHandlerBase {
    ...
    protected String getURL(){
        ...
        return bundle.getString("CORREO_VERIFICACION_CAU");
    }
    ...
    public void process(ServletContext sc, HttpServletRequest request, HttpServletResponse response)
            ...
            String correo = "atencion.soporte@venvidrio.com.ve";
            System.out.println("------------------------");
