	...
	String NOMBRE = nombre.toUpperCase();
        ...
        <div class="jumbotron boxbienvenida">
            <div class="container">                
                ...
                <p style="color: white;">Te damos la bienvenida a nuestra nueva pagina, cambiamos para que tengas una mejor experiencia.<br>Visitanos para que disfrutes de nuestro descuento de Semana Santa 2015</p> 
            </div>
        </div>
                ...
                <div class="list-group">
                    <div class="col-lg-4 text-center">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3>Tankinis</h3> 
                                <a href="tankinis_pedir.jsp" class="btn btn-warning">Ver más »</a>
                            </div>
                        </div>                
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3>Bikinis</h3>
                                <a href="bikinis_pedir.jsp" class="btn btn-warning">Ver más »</a>
                            </div>
                        </div>                
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3>Enteros</h3>
                                <a href="enteros_pedir.jsp" class="btn btn-warning">Ver más »</a>
                            </div>
                        </div>                
                    </div>
                    <div class="col-lg-4 text-center">
