...
//	
            ...
            function atras(){
                document.f_forma.action="Controller?event=HISTORICO_REQUERIMIENTOS";
            }               
	...
	barra = util.mostrarBarra(rol);
       ...
       String historial = pendiente.verHistorialRequerimiento(var);
        if(var != "NULL"){            
            ...
            tabla = pendiente.verDetallesHistorial(var); 
        }else{
            ...
            tabla = pendiente.verDetallesHistorial(var2);
        } 
        ...
        <section id="centroAprobar">
            ...
            <form name="f_forma" method="post">
                ...
                <hr>            
        <section>
            <div style="width: 970px; margin-left: 225px; margin-top: -400px;">
