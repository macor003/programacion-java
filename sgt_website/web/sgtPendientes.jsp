...
<html>
     <head>
        ...
        <script>
           ...
           function ejecutaCodigo(nombre){
               document.f_forma.action = "Controller?event=DETALLE_REQUERIMIENTO_PENDIENTE";
	...
	barra = util.mostrarBarra(rol);
            ...
            String tabla = pendiente.verRequerimientosPendientes();
        ...
        <div id="UsuarioSesion">
            ...
            <label id="tituloPendiente">Requerimientos para Asignar</label>
