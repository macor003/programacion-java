        ...
        <script>
           ...
           function Asignar(){
              var cod = "<%= request.getParameter("codigo")%>";
               ...
               if(!fsj_validaSelect("lm_ficha","un analista")){return false;}
...
//	
            ...
            function atras(){
                document.f_forma.action="Controller?event=CREADOS";
            }
	...
	barra = util.mostrarBarra(rol);
       ...
       String historial = pendiente.verHistorialRequerimiento(var);
        if(var != "NULL"){            
            pendiente.verDetallesRequerimientoPendientesUsuarioLog(var);
            System.out.println("Codigo del Requerimieno JSP Detalle: "+ var);
            tabla = pendiente.verDetallesRequerimientoPendientesUsuarioLog(var); 
        }else{
        ...
        <section id="centroAprobar">
            ...
            <form name="f_forma" method="post">
                ...
                <hr>            
        <section>
            <div style="width: 970px; margin-left: 225px; margin-top: -600px;">
                <table id="tablaHistorial" class="display" cellspacing="0" width="100%" style=" border: 1px solid #A60A0A; margin-top: 10px;">
                    <caption style="font-size: 20px;">Historial del requerimiento</caption>
