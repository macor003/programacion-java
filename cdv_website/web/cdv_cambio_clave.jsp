...
<html>
    <head>
        ...
        <script>
           ...
           // function GuardarDatos(){
             //   if(window.confirm("¿Esta seguro de que desea guardar esta información?")){
               //     document.f_forma.submit();
               // }
           // }
        </script>
        ...
        <div class="container"> 
            ...
            <div class="col-lg-3">           
                <div class="panel panel-primary" style="background-color: white; box-shadow: 0 8px 17px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="panel-heading"><h3>Mario Ortega</h3></div>
            ...
            <div class="col-lg-9">
                <div class="panel panel-default" style="background-color: white; box-shadow: 0 8px 17px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="panel-heading">
                        <h3><span class="fa fa-user"></span> Cuenta</h3>
                        <h4 class="text-muted">Cambia tus configuraciones básicas</h4>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" action="Controller?event=ACTUALIZAR_CUENTA" name="f_forma" method="post">
                            <%= configurar %>
                        </form>
                    </div>
                    <div class="clearfix visible-lg"></div>
