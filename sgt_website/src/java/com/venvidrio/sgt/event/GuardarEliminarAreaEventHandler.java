 ...
 * @author Ortegam
 */
public class GuardarEliminarAreaEventHandler extends EventHandlerBase {
    ...
    protected String getURL(){
        ...
        return bundle.getString("GUARDAR_ELIMINAR_AREA");
    }     
    @Override
    public void process(ServletContext sc, HttpServletRequest request, HttpServletResponse response)
            ...
            String cod_area = (String) request.getParameter("cod_area_eliminar");
