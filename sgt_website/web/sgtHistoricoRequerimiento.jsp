...
<html>
     <head>
        ...
        <script>
           ...
           function ejecutaCodigo(nombre){
               document.f_forma.action = "Controller?event=DETALLE_HISTORICO_REQUERIMIENTO";
	...
	barra = util.mostrarBarra(rol);
            ...
            String tabla = pendiente.verRequerimientosHistorico();
        ...
        <div id="UsuarioSesion">
            ...
            <label id="tituloPendiente">Histórico de Requerimientos</label>
