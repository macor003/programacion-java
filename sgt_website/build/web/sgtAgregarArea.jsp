...
<html>
	...
	barra = util.mostrarBarra(rol);
            ...
            String nuevo_cod_area = ver.VerSiguienteCodArea();
        %>
        ...
        <h2 id="tituloArea" style="margin-left: 50px;">Agregar nueva area</h2>
        <section id="sectionAgregarArea">
            <form name="f_form" action="Controller?event=GUARDAR_CREAR_AREA" method="post">
                ...
                <input type="text" name="cod_area" id="cod_area" value="0<%= nuevo_cod_area %>" style="margin-top: 30px; margin-left: 40px;"  readonly><br>
                <label class="EtiquetaEnForm" style="margin-left: 90px;">Descripción del area</label>
                <input type="text" name="desc_area" id="desc_area" style="margin-left: 10px; margin-top: 10px;"><br>
                <button type="button" onclick="CrearArea();" class="claseBtn" style="margin-left: -120px; margin-top: 10px;">Agregar</button>
